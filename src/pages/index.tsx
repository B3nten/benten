                ...
                <div className="grid lg:grid-cols-2 gap-10 max-w-3xl">
                    <div className='block group relative w-full p-6 bg-background-focus rounded-lg'>
                        ...
                        <ul className='mt-10 space-y-4'>
                            <li>
                                <a rel='external' target='_blank' href='https://github.com/B3nten/tabletop-journal'>
                                    <div className="flex items-center space-x-2">
                    ...
                    <a rel='external' target='_blank' href='https://artstation.com/benten28' className='block group relative w-full p-6 bg-background-focus rounded-lg aspect-square'>
                        ...
                        <img className='mt-5' src="/assets/artstation.png" alt="" />
                    </a>
                </div>
            </section>
        </div>
